...
module.exports = function() {
	...
	var {AssignmentOperatorKind, BinaryOperatorKind, ModifierKind, NodeKind, ReificationKind, ScopeKind, UnaryOperatorKind} = require("@kaoscript/ast")();
	let AST = (function() {
		const $polyadic = {};
		...
		function BinaryExpression() {
			if(arguments.length === 1) {
				...
				let right = arguments[++__ks_i];
				if(right === void 0 || right === null) {
					throw new TypeError("'right' is not nullable");
				}
				let __ks__;
				let first = arguments.length > 3 && (__ks__ = arguments[++__ks_i]) !== void 0 && __ks__ !== null ? __ks__ : left;
				let last = arguments.length > 4 && (__ks__ = arguments[++__ks_i]) !== void 0 && __ks__ !== null ? __ks__ : right;
				return location({
					kind: NodeKind.BinaryExpression,
					operator: operator.value,
					left: left.value,
		...
		function BindingElement() {
			if(arguments.length === 1) {
				...
				let alias = arguments[++__ks_i];
				if(alias === void 0) {
					alias = null;
				}
				let spread = arguments[++__ks_i];
				if(spread === void 0) {
					spread = null;
				}
				let defaultValue = arguments[++__ks_i];
		...
		function ExportAlias(name, alias) {
			if(arguments.length < 2) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 2)");
			}
			if(name === void 0 || name === null) {
		...
		function ImportDeclarator(module, specifiers, references, first, last) {
			if(arguments.length < 5) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 5)");
			}
			...
			if(references !== null) {
				node.references = Helper.mapArray(references, function(reference) {
		...
		function ImportReference() {
			if(arguments.length === 1) {
				...
				let foreign = arguments[++__ks_i];
				if(foreign === void 0 || foreign === null) {
					throw new TypeError("'foreign' is not nullable");
				}
				return location({
					kind: NodeKind.ImportReference,
					alias: alias.value,
		...
		function ImportSpecifier(alias, local, first, last) {
			if(arguments.length < 4) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 4)");
			}
			if(alias === void 0 || alias === null) {
			...
			if(Type.isValue(local)) {
				node.local = local.value;
			}
			return node;
		}
		function ImportWildcardSpecifier(local, first, last) {
			if(arguments.length < 3) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 3)");
			}
			if(local === void 0) {
		...
		function IncludeOnceDeclaration(files, first, last) {
			if(arguments.length < 3) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 3)");
			}
			if(files === void 0 || files === null) {
		...
		function Literal() {
			...
			let __ks__;
			let last = arguments.length > 2 && (__ks__ = arguments[++__ks_i]) !== void 0 ? __ks__ : null;
			return location({
				kind: NodeKind.Literal,
				value: value
			}, first, last);
		}
		function MacroDeclaration(name, rules, first, last) {
			if(arguments.length < 4) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 4)");
			}
			if(name === void 0 || name === null) {
			...
			return location({
				...
				name: name.value,
				rules: Helper.mapArray(rules, function(rule) {
					return rule.value;
				})
			}, first, last);
		}
		...
		function MacroParameter(elements, first, last) {
			if(arguments.length < 3) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 3)");
			}
			if(elements === void 0 || elements === null) {
		...
		function MacroRule(parameters, body, first, last) {
			if(arguments.length < 4) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 4)");
			}
			if(parameters === void 0 || parameters === null) {
			...
			return location({
				...
				parameters: Helper.mapArray(parameters, function(parameter) {
					return parameter.value;
				}),
				body: Helper.mapArray(body, function(statement) {
					return statement.value;
				})
			}, first, last);
		}
		function MacroVariable(expression, reification, first, last) {
			if(arguments.length < 4) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 4)");
			}
			if(expression === void 0 || expression === null) {
		...
		function MemberExpression() {
			...
			let __ks__;
			let first = arguments.length > 4 && (__ks__ = arguments[++__ks_i]) !== void 0 && __ks__ !== null ? __ks__ : object;
			let last = arguments.length > 5 && (__ks__ = arguments[++__ks_i]) !== void 0 && __ks__ !== null ? __ks__ : property;
			return location({
		...
		function ObjectMember() {
			if(arguments.length === 1) {
				...
				let __ks_i = -1;
				let attributes = arguments[++__ks_i];
				if(attributes === void 0) {
					attributes = null;
				}
				let name = arguments[++__ks_i];
		...
		function Parameter() {
			if(arguments.length === 1) {
				...
				let modifiers = arguments[++__ks_i];
				if(modifiers === void 0 || modifiers === null) {
					throw new TypeError("'modifiers' is not nullable");
				}
				let defaultValue = arguments[++__ks_i];
		...
		function TypeReference() {
			if(arguments.length === 1) {
				...
				let parameters = arguments[++__ks_i];
		...
		function VariableDeclarator() {
			if(arguments.length === 1) {
				...
				let __ks_sealed_1 = arguments[++__ks_i];
		...
		return {
			...
			ImportWildcardSpecifier: ImportWildcardSpecifier,
			Identifier: Identifier,
			IncludeDeclaration: IncludeDeclaration,
			IncludeOnceDeclaration: IncludeOnceDeclaration,
		...
		function MODULE_STATEMENT(that, index) {
			...
			if(c === -1) {
				...
				if((that.charAt(1) === 110) && (that.charAt(2) === 99) && (that.charAt(3) === 108) && (that.charAt(4) === 117) && (that.charAt(5) === 100) && (that.charAt(6) === 101)) {
					if((that.charAt(7) === 32) && (that.charAt(8) === 111) && (that.charAt(9) === 110) && (that.charAt(10) === 99) && (that.charAt(11) === 101) && that.isBoundary(12)) {
						that.next(12);
	...
	class Scanner {
		...
		__ks_func_match_0(...tokens) {
			if(this._eof) {
				...
				const c = this.skip(this._index - 1);
				if(c === -1) {
					return this.eof();
				}
	...
	class Parser {
		...
		__ks_func_yes_1(value) {
			...
			const start = Type.isValue(value.start) ? value.start : this._scanner.startPosition();
			const end = Type.isValue(value.end) ? value.end : this._scanner.endPosition();
			this.commit();
			return {
				ok: true,
				value: value,
		...
		__ks_func_altArrayComprehension_0(expression, first) {
			if(arguments.length < 2) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 2)");
			}
			if(expression === void 0 || expression === null) {
		...
		__ks_func_altArrayList_0(expression, first) {
			if(arguments.length < 2) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 2)");
			}
			if(expression === void 0 || expression === null) {
		...
		__ks_func_altDestructuringObjectItem_0(name) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(name === void 0 || name === null) {
		...
		altDestructuringObjectItem() {
			if(arguments.length === 1) {
				return Parser.prototype.__ks_func_altDestructuringObjectItem_0.apply(this, arguments);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_altForExpressionFrom_0(declaration, variable, first) {
			if(arguments.length < 3) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 3)");
			}
			if(declaration === void 0 || declaration === null) {
		...
		__ks_func_altForExpressionIn_0(declaration, value, index, expression, first) {
			if(arguments.length < 5) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 5)");
			}
			if(declaration === void 0 || declaration === null) {
		...
		__ks_func_altForExpressionInRange_0(declaration, value, index, first) {
			if(arguments.length < 4) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 4)");
			}
			if(declaration === void 0 || declaration === null) {
		...
		__ks_func_altForExpressionOf_0(declaration, key, value, first) {
			if(arguments.length < 4) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 4)");
			}
			if(declaration === void 0 || declaration === null) {
		...
		__ks_func_altForExpressionRange_0(declaration, value, index, from, til, to, by, first) {
			if(arguments.length < 8) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 8)");
			}
			if(declaration === void 0 || declaration === null) {
		...
		__ks_func_altLetStatementAwait_0(first, variables, equals) {
			if(arguments.length < 3) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 3)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqAttribute_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqAttributeBlock_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqAttributeList_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqAttributeMember_0() {
			...
			if(this.match(Token.MINUS, Token.EQUALS, Token.LEFT_ROUND) === Token.MINUS) {
				...
				this.commit();
				const __ks_arguments_1 = [this.reqAttributeMember()];
		...
		__ks_func_reqClassField_0(attributes, modifiers, name, type, first) {
			if(arguments.length < 5) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 5)");
			}
			if(attributes === void 0) {
		...
		__ks_func_reqClassMethod_0(attributes, modifiers, name, round, first) {
			if(arguments.length < 5) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 5)");
			}
			if(attributes === void 0) {
		...
		__ks_func_reqConstStatement_0() {
			...
			let __ks__;
			let mode = arguments.length > 1 && (__ks__ = arguments[++__ks_i]) !== void 0 && __ks__ !== null ? __ks__ : ExpressionMode.Default;
		...
		__ks_func_reqCreateExpression_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqDestroyStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		reqDestroyStatement() {
			if(arguments.length === 1) {
				return Parser.prototype.__ks_func_reqDestroyStatement_0.apply(this, arguments);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_reqDestructuringArray_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqDestructuringArrayItem_0() {
		...
		__ks_func_reqDestructuringObject_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqDestructuringObjectItem_0() {
			if(this.match(Token.LEFT_CURLY, Token.LEFT_SQUARE, Token.IDENTIFIER) === Token.LEFT_CURLY) {
				...
				if(this.test(Token.IDENTIFIER)) {
					const identifier = this.yep(AST.Identifier(this._scanner.value(), this.yes()));
					if(this.test(Token.RIGHT_SQUARE)) {
		...
		__ks_func_reqDoStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqEnumStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqExportDeclarator_0() {
			...
			else if(this._token === Token.CONST) {
			...
			else if(this._token === Token.TYPE) {
		...
		__ks_func_reqExpression_0() {
			...
			let __ks__;
			let terminator = arguments.length > 1 && (__ks__ = arguments[++__ks_i]) !== void 0 ? __ks__ : null;
			if(mode === null) {
		...
		__ks_func_reqExpression0CNList_0() {
			this.NL_0M();
			if(this.test(Token.RIGHT_ROUND)) {
				return this.yep([]);
			}
		...
		__ks_func_reqExpressionStatement_0() {
			const expression = this.reqExpression(ExpressionMode.Default);
		...
		__ks_func_reqExternClassDeclaration_0() {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			let __ks_i = -1;
		...
		__ks_func_reqExternClassMember_0(modifiers, first) {
			if(arguments.length < 2) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 2)");
			}
			if(modifiers === void 0 || modifiers === null) {
		...
		__ks_func_reqExternClassMethod_0(modifiers, name, round, first) {
			if(arguments.length < 4) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 4)");
			}
			if(modifiers === void 0 || modifiers === null) {
		...
		__ks_func_reqExternDeclarator_0() {
			let __ks_0 = this.matchM(M.EXTERN_STATEMENT);
			if(__ks_0 === Token.ABSTRACT) {
				const __ks_abstract_1 = this.yep(AST.Modifier(ModifierKind.Abstract, this.yes()));
				...
				const __ks_sealed_1 = this.yep(AST.Modifier(ModifierKind.Sealed, this.yes()));
		...
		reqExternDeclarator() {
			if(arguments.length === 0) {
				return Parser.prototype.__ks_func_reqExternDeclarator_0.apply(this);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_reqExternNamespaceDeclaration_0() {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			let __ks_i = -1;
		...
		__ks_func_reqForExpression_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqForStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqFunctionModifiers_0() {
		...
		__ks_func_reqFunctionStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqIfStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqImportReference_0() {
		...
		reqImportReference() {
			if(arguments.length === 0) {
				return Parser.prototype.__ks_func_reqImportReference_0.apply(this);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_reqImportSpecifier_0() {
		...
		reqImportSpecifier() {
			if(arguments.length === 0) {
				return Parser.prototype.__ks_func_reqImportSpecifier_0.apply(this);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		...
		__ks_func_reqIncludeOnceStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		reqIncludeOnceStatement() {
			if(arguments.length === 1) {
				return Parser.prototype.__ks_func_reqIncludeOnceStatement_0.apply(this, arguments);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_reqLetStatement_0() {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			let __ks_i = -1;
		...
		__ks_func_reqMacroElements_0(elements, terminator) {
			...
			let literal = null;
			let first, last;
			const addLiteral = (...__ks_arguments) => {
				let __ks_i = -1;
				if(literal !== null) {
			...
			const addToLiteral = (...__ks_arguments) => {
				let __ks_i = -1;
				if(literal === null) {
			...
			while(true) {
				let __ks_0 = this.matchM(M.MACRO);
				if(__ks_0 === Token.EOF) {
		...
		__ks_func_reqMacroExpression_0() {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			let __ks_i = -1;
			...
			let __ks__;
			let terminator = arguments.length > 1 && (__ks__ = arguments[++__ks_i]) !== void 0 && __ks__ !== null ? __ks__ : MacroTerminator.NEWLINE;
			const elements = [];
			if(this.test(Token.LEFT_CURLY)) {
				if(first.ok) {
					this.commit();
		...
		__ks_func_reqMacroParameter_0(parameters) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(parameters === void 0 || parameters === null) {
			...
			let last = first;
			while(true) {
				let __ks_0 = this.match(Token.COMMA, Token.RIGHT_ROUND);
				if(__ks_0 === Token.COMMA) {
					this.commit();
		...
		reqMacroParameter() {
			if(arguments.length === 1) {
				return Parser.prototype.__ks_func_reqMacroParameter_0.apply(this, arguments);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_reqMacroParameterOperand_0() {
		...
		reqMacroParameterOperand() {
			if(arguments.length === 0) {
				return Parser.prototype.__ks_func_reqMacroParameterOperand_0.apply(this);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_reqMacroRule_0(first, capture) {
			if(arguments.length < 2) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 2)");
			}
			if(first === void 0 || first === null) {
			...
			if(capture === void 0 || capture === null) {
				throw new TypeError("'capture' is not nullable");
			}
			const parameters = [];
			if(!this.test(Token.RIGHT_ROUND)) {
		...
		reqMacroRule() {
			if(arguments.length === 2) {
				return Parser.prototype.__ks_func_reqMacroRule_0.apply(this, arguments);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_reqMacroStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
			...
			let last;
			const rules = [];
			let __ks_0 = this.match(Token.LEFT_CURLY, Token.LEFT_ROUND);
			if(__ks_0 === Token.LEFT_CURLY) {
				this.commit().NL_0M();
				while(!(this.match(Token.RIGHT_CURLY))) {
					if(!this.test(Token.LEFT_ROUND)) {
						this.throw("(");
					}
				...
				if(!this.match(Token.RIGHT_CURLY)) {
					this.throw("}");
				}
				last = this.yes();
			}
		...
		__ks_func_reqModule_0() {
			...
			while(!(this._scanner.isEOF())) {
				if(this.test(Token.HASH_EXCLAMATION_LEFT_SQUARE)) {
					...
					let __ks_0 = this.matchM(M.MODULE_STATEMENT);
					...
					else if(__ks_0 === Token.INCLUDE_ONCE) {
		...
		__ks_func_reqNamespaceStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
			...
			while(!(this.test(Token.RIGHT_CURLY))) {
				...
				else if(this._token === Token.INCLUDE_ONCE) {
		...
		__ks_func_reqParameter_0(parameters) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(parameters === void 0 || parameters === null) {
		...
		__ks_func_reqParameterIdendifier_0(modifiers, first) {
			if(arguments.length < 2) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 2)");
			}
			if(modifiers === void 0 || modifiers === null) {
		...
		__ks_func_reqParameterModifiers_0() {
			const modifiers = [];
			if(this.test(Token.DOT_DOT_DOT)) {
				const first = this.yes();
				if(this.test(Token.LEFT_CURLY)) {
		...
		reqParameterModifiers() {
			if(arguments.length === 0) {
				return Parser.prototype.__ks_func_reqParameterModifiers_0.apply(this);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_reqParenthesis_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqPostfixedOperand_0() {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			let __ks_i = -1;
			...
			let operator;
			let __ks_0 = this.matchM(M.POSTFIX_OPERATOR);
		...
		__ks_func_reqReturnStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqStatement_0() {
			const mark = this.mark();
			let statement = NO;
			let __ks_0 = this.matchM(M.STATEMENT);
			if(__ks_0 === Token.ABSTRACT) {
				const first = this.yes();
				if(this.test(Token.CLASS)) {
					this.commit();
		...
		__ks_func_reqSwitchBindingValue_0() {
			let __ks_0 = this.match(Token.LEFT_CURLY, Token.LEFT_SQUARE);
			if(__ks_0 === Token.LEFT_CURLY) {
				const first = this.yes();
				const elements = [];
				if(!this.test(Token.RIGHT_CURLY)) {
		...
		__ks_func_reqSwitchCaseExpression_0() {
			let __ks_0 = this.match(Token.LEFT_CURLY, Token.RETURN, Token.THROW);
			if(__ks_0 === Token.LEFT_CURLY) {
				return this.reqBlock(this.yes());
			}
			else if(__ks_0 === Token.RETURN) {
		...
		__ks_func_reqSwitchCaseList_0() {
			...
			while(!(this.test(Token.RIGHT_CURLY))) {
				...
				let __ks_0 = this.match(Token.WITH, Token.WHERE, Token.EQUALS_RIGHT_ANGLE);
				if(__ks_0 === Token.EQUALS_RIGHT_ANGLE) {
					...
					this.NL_0M();
					let __ks_1 = this.match(Token.WHERE, Token.EQUALS_RIGHT_ANGLE);
					...
					this.NL_0M();
					let __ks_1 = this.match(Token.WITH, Token.WHERE, Token.EQUALS_RIGHT_ANGLE);
					if(__ks_1 === Token.EQUALS_RIGHT_ANGLE) {
						this.commit();
						body = this.reqSwitchCaseExpression();
					}
						...
						bindings = this.reqSwitchBinding();
						this.NL_0M();
						let __ks_2 = this.match(Token.WHERE, Token.EQUALS_RIGHT_ANGLE);
		...
		__ks_func_reqSwitchCondition_0() {
			let __ks_0 = this.match(Token.LEFT_CURLY, Token.LEFT_SQUARE, Token.IS, Token.COLON);
		...
		__ks_func_reqSwitchConditionValue_0() {
			const operand = this.reqPrefixedOperand(ExpressionMode.Default);
		...
		__ks_func_reqSwitchStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqTemplateExpression_0() {
			const first = this.yes();
			const elements = [];
			while(true) {
		...
		__ks_func_reqThrowStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqTryCatchClause_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqCatchOnClause_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqTryStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqTypeStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqTypedIdentifier_0() {
			const identifier = this.reqIdentifier();
			if(this.test(Token.COLON)) {
				this.commit();
				const type = this.reqTypeVar();
		...
		__ks_func_reqUnaryOperand_0() {
			...
			let __ks__;
			let value = arguments.length > 1 && (__ks__ = arguments[++__ks_i]) !== void 0 ? __ks__ : null;
			if(value === null) {
				value = this.reqOperand(mode);
			}
			let expression, mark, first;
			while(true) {
				let __ks_0 = this.matchM(M.OPERAND_JUNCTION);
				if(__ks_0 === Token.ASTERISK_ASTERISK_LEFT_ROUND) {
					...
					this.commit();
					const __ks_arguments_1 = this.reqExpression0CNList();
		...
		__ks_func_reqUnlessStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqUntilStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		reqUntilStatement() {
			if(arguments.length === 1) {
				return Parser.prototype.__ks_func_reqUntilStatement_0.apply(this, arguments);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		__ks_func_reqVariableEquals_0() {
		...
		__ks_func_reqVariableIdentifier_0() {
		...
		__ks_func_reqVariableName_0(object) {
			if(object === void 0 || object === null) {
				object = NO;
			}
			if(!object.ok) {
		...
		__ks_func_reqWhileStatement_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		reqWhileStatement() {
			if(arguments.length === 1) {
				return Parser.prototype.__ks_func_reqWhileStatement_0.apply(this, arguments);
			}
			throw new SyntaxError("wrong number of arguments");
		}
		...
		__ks_func_tryBinaryOperator_0() {
			let __ks_0 = this.matchM(M.BINARY_OPERATOR);
		...
		__ks_func_tryDestructuringArray_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_tryDestructuringObject_0(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_tryFunctionParameterList_0() {
			if(!this.test(Token.LEFT_ROUND)) {
				return NO;
			}
			const first = this.yes();
		...
		__ks_func_tryNumber_0() {
			if(this.matchM(M.NUMBER) === Token.BINARY_NUMBER) {
				...
				const data = /^(\d+)r(.*)$/.exec(this._scanner.value());
		...
		__ks_func_tryParameter_0(parameters) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(parameters === void 0 || parameters === null) {
		...
		__ks_func_tryPrefixedOperand_0(mode) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(mode === void 0 || mode === null) {
		...
		__ks_func_trySwitchExpression_0(mode) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(mode === void 0 || mode === null) {
