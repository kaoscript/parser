...
module.exports = function() {
	...
	var AssignmentOperatorKind = __ks__.AssignmentOperatorKind, BinaryOperatorKind = __ks__.BinaryOperatorKind, ModifierKind = __ks__.ModifierKind, NodeKind = __ks__.NodeKind, ReificationKind = __ks__.ReificationKind, ScopeKind = __ks__.ScopeKind, UnaryOperatorKind = __ks__.UnaryOperatorKind;
	var AST = (function() {
		var $polyadic = {};
	...
	var Parser = Helper.class({
		...
		__ks_func_reqClassMemberList_0: function(members) {
			...
			if(this.test(Token.MACRO)) {
				...
				if(this.test(Token.IDENTIFIER)) {
					var statement = this.reqMacroStatement(first);
					if(statement.ok) {
						this.reqNL_1M();
						if(attributes === null) {
			...
			if(this.test(Token.ABSTRACT)) {
				...
				if(this.test(Token.LEFT_CURLY)) {
					...
					var member = this.reqClassAbstractMethod(attributes, modifiers, first);
					if(member.ok) {
						members.push(member);
					}
					else {
				...
				if(this.test(Token.LEFT_CURLY)) {
					...
					var member = this.reqClassMember(attributes, modifiers, first);
					if(member.ok) {
						members.push(member);
					}
					else {
			...
			if(!this.test(Token.RIGHT_ROUND)) {
				while(true) {
					if(this.test(Token.AT)) {
						var first = this.yes();
						var modifiers = [AST.Modifier(ModifierKind.ThisAlias, first)];
						var identifier = this.reqIdentifier();
						var last = identifier;
						if(this.test(Token.LEFT_ROUND)) {
							var __ks_first_1 = this.yes();
							...
							modifiers.push(last = AST.Modifier(ModifierKind.SetterAlias, __ks_first_1, this.yes()));
						}
						if(this.test(Token.EQUALS)) {
							this.commit();
							var defaultValue = this.reqExpression(ExpressionMode.Default);
		...
		__ks_func_reqDestroyStatement_0: function(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqIncludeOnceStatement_0: function(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		reqIncludeOnceStatement: function() {
			if(arguments.length === 1) {
				...
				if(__ks_0 === Token.EOF) {
					...
					if(this.testNS(Token.IDENTIFIER)) {
						...
						if((identifier.length === 1) && ((identifier === "a") || (identifier === "b") || (identifier === "e") || (identifier === "i")) && this.test(Token.LEFT_ROUND)) {
							...
							elements.push(this.yep(AST.MacroVariable(expression, reification, __ks_first_1, this.yes())));
						}
						else {
							var expression = this.yep(AST.Identifier(identifier, __ks_last_1));
							elements.push(this.yep(AST.MacroVariable(expression, null, __ks_first_1, expression)));
						}
					}
						...
						elements.push(this.yep(AST.MacroVariable(expression, null, __ks_first_1, this.yes())));
					}
					else {
						this.throw();
					}
		...
		__ks_func_reqMacroParameter_0: function(parameters) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(parameters === void 0 || parameters === null) {
			...
			var first = this.reqMacroParameterOperand();
			var elements = [first];
			var last = first;
			while(true) {
				var __ks_0 = this.match(Token.COMMA, Token.RIGHT_ROUND);
				if(__ks_0 === Token.COMMA) {
					...
					var operator = this.tryBinaryOperator();
					if(operator.ok) {
		...
		__ks_func_reqMacroRule_0: function(first, capture) {
			...
			if(capture) {
				...
				this.commit();
				var expression = this.reqMacroExpression(NO);
		...
		__ks_func_reqMacroStatement_0: function(first) {
			...
			var last;
			var rules = [];
			var __ks_0 = this.match(Token.LEFT_CURLY, Token.LEFT_ROUND);
		...
		__ks_func_reqParameter_0: function(parameters) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(parameters === void 0 || parameters === null) {
		...
		__ks_func_reqParameterModifiers_0: function() {
			var modifiers = [];
			if(this.test(Token.DOT_DOT_DOT)) {
				var first = this.yes();
				if(this.test(Token.LEFT_CURLY)) {
		...
		reqParameterModifiers: function() {
			if(arguments.length === 0) {
		...
		__ks_func_reqUntilStatement_0: function(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_reqWhileStatement_0: function(first) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(first === void 0 || first === null) {
		...
		__ks_func_tryParameter_0: function(parameters) {
			if(arguments.length < 1) {
				throw new SyntaxError("wrong number of arguments (" + arguments.length + " for 1)");
			}
			if(parameters === void 0 || parameters === null) {
